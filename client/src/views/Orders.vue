...
export default {
  ...
  setup() {
    ...
    // Restocking orders placed from the Restocking tab are flagged
    // source="restocking" by the backend; surface them separately here so
    // their delivery lead time is visible.
